...
corrM2Order = form[1][['g02', 'g11', 'g04', 'g01', 'g05', 'g09', 'g07', 'g03', 'g08', 'g10', 'g06', 'g12']].corr(method='spearman')
corrM4Order = form[3][['g02', 'g11', 'g04', 'g01', 'g05', 'g09', 'g07', 'g03', 'g08', 'g10', 'g06', 'g12']].corr(method='spearman')
# corrM4Order = corrM4[-1:] + corrM4[:-1]
...
axes[0, 0].set_title('Jedna strana - redom')
sns.heatmap(corrM2Order, cmap="RdBu_r", center=0, vmin=-1, vmax=1, ax=axes[0, 1], square=True, cbar_kws={"shrink": .5}, xticklabels=True)
axes[0, 1].set_title('Jedna strana - pomešano')
sns.heatmap(corrM3, cmap="RdBu_r", center=0, vmin=-1, vmax=1, ax=axes[1, 0], square=True, cbar_kws={"shrink": .5}, xticklabels=True)
axes[1, 0].set_title('Slajdovi - redom')
sns.heatmap(corrM4Order, cmap="RdBu_r", center=0, vmin=-1, vmax=1, ax=axes[1, 1], square=True, cbar_kws={"shrink": .5}, xticklabels=True)
axes[1, 1].set_title('Slajdovi - pomešano')
...
matrica_Redom = pd.concat([corrM1, corrM3], ignore_index=True)
matrica_Mesano = pd.concat([corrM2, corrM4], ignore_index=True)
...
sns.heatmap(matrica_Redom, cmap="RdBu_r", center=0, vmin=-1, vmax=1, ax=axes[1, 0], square=True, cbar_kws={"shrink": .5}, xticklabels=True)
axes[1, 0].set_title('Grid pitanja - Redom')

sns.heatmap(matrica_Mesano, cmap="RdBu_r", center=0, vmin=-1, vmax=1, ax=axes[1, 1], square=True, cbar_kws={"shrink": .5}, xticklabels=True)
axes[1, 1].set_title('Grid pitanja - Mešano')
